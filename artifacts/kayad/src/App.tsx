// src/App.tsx
// ─────────────────────────────────────────────────────────────────────
// KAYAD application root — adapted for Replit workspace
// ─────────────────────────────────────────────────────────────────────
...
const Dealer = ({ children }: { children: React.ReactNode }) => (
  <RequireAuth>
    <RequireSeller>
...
const SecureAdmin = ({ children, roles }: { children: React.ReactNode; roles?: string[] }) => (
...
export default function App() {
  // Use Vite's BASE_URL for the router basename (handles Replit path routing)
                  ...
                  <CompareProvider>
                    ...
                    <Suspense fallback={<LoadingPage />}>
                      <Routes>
                        ...
                        <Route path="/advertising"         element={<Public><AdvertisingPage /></Public>} />
