            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {previews.length > 0 && (
                <div className="grid-4" style={{ gap: 8 }}>
                  {previews.map((src, i) => (
                    <div key={i} style={{ aspectRatio: '4/3', borderRadius: 8, overflow: 'hidden', position: 'relative', border: `2px solid ${i === coverImage ? 'var(--gold)' : 'transparent'}`, transition: 'all 0.15s' }}>
                      <img src={src} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', cursor: 'pointer' }} onClick={() => setCoverImage(i)} />
                      {i === coverImage && (
                        <div style={{
                      ...
                      <button onClick={() => {
                        ...
                        if (coverImage >= next.length) setCoverImage(Math.max(0, next.length - 1));
                      }} style={{
                        position: 'absolute', top: 4, right: 4, width: 22, height: 22, borderRadius: '50%',
                        border: 'none', background: 'rgba(255,68,68,0.85)', color: '#fff', cursor: 'pointer',
