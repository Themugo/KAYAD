...
import { runFraudCheck } from "../services/fraudDetectionService.js";
  ...
  try {
    ...
    switch (type) {
      case "user_registration":
        result = await runFraudCheck("user", userId, metadata);
        break;
      case "car_listing":
        result = await runFraudCheck("car", carId, metadata);
        break;
      case "payment":
        result = await runFraudCheck("payment", paymentId, { amount, ...metadata });
        break;
      case "bid":
        result = await runFraudCheck("bid", carId, { userId, amount, ...metadata });
        break;
      default:
