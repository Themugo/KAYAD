...
import { protect, dealerOnly, adminOnly, optionalAuth } from "../middleware/auth.ts";

import asyncHandler from "../middleware/asyncHandler.ts";
import { validateObjectId, validateCar } from "../middleware/validate.ts";

import upload, { handleUploadError } from "../middleware/upload.ts";
import MarketData from "../models/MarketData.ts";
import { uploadLimiter, bidLimiter, createLimiter } from "../middleware/rateLimiter.ts";
import { cacheResponse, invalidateCache } from "../middleware/cacheMiddleware.ts";
import { cacheVehicleSearch, invalidateVehicleSearchCache } from "../middleware/searchCache.ts";
import { trackCarSearch } from "../middleware/searchTracking.ts";
import { trackVehicleSearchLatency } from "../middleware/searchLatencyTracking.ts";
import { logActionFromReq } from "../utils/securityLogger.ts";
import { STAFF_ROLES } from "../config/roles.ts";
import { requireDealerVerification } from "../middleware/dealerVerification.ts";
