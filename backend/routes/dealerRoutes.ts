...
import { protect, dealerOnly } from "../middleware/auth.ts";
...
import { getPagination, withPagination } from "../middleware/apiPagination.ts";
import { cacheDealerData, cacheAnalytics, invalidateCache } from "../middleware/apiCache.ts";
...
import DealerTeam from "../models/DealerTeam.ts";
...
try {
  dealerEmailService = await import("../services/email.service.ts");
} catch (e) {
...
// =============================
import { startAuction, endAuction } from "../realtime/auctionEngine.ts";
import { syncAuctionResult } from "../realtime/syncService.ts";
