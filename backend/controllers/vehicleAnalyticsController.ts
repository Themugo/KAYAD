...
import {
  ...
  getPriceTrend,
  getVolumeTrend,
} from "../services/vehicleAnalyticsService.ts";
import { triggerAnalyticsGeneration } from "../services/marketTrendScheduler.ts";
import VehicleMarketAnalytics from "../models/VehicleMarketAnalytics.ts";
