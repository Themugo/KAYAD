...
import { findOrCreateLeadFromChat, addLeadActivity, updateLeadStage } from "../services/leadService.ts";
...
export const sendMessage = async (req, res) => {
  try {
    ...
    try {
      const { sendNewMessageEmail } = await import("../services/email.service.ts");
