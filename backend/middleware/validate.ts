import { validationError, error } from "../utils/response.ts";
import { z } from "zod";
import {
  registerSchema,
  loginSchema,
...
import { createCarSchema, updateCarSchema } from "../validation/car.schema.ts";
import { initiatePaymentSchema, paymentCallbackSchema } from "../validation/payment.schema.ts";
import {
  createEscrowSchema,
  escrowActionSchema,
  releaseEscrowSchema,
  ...
  releaseOtpSchema,
} from "../validation/escrow.schema.ts";
import { createChatSchema, sendMessageSchema } from "../validation/chat.schema.ts";
import {
  orderInspectionSchema,
  confirmPaymentSchema,
  assignInspectorSchema,
  submitInspectionSchema,
} from "../validation/inspection.schema.ts";
import {
  queueNtsaVerificationSchema,
  processNtsaVerificationSchema,
  addNtsaDocumentSchema,
} from "../validation/ntsa.schema.ts";
import { createSavedSearchSchema, updateSavedSearchSchema } from "../validation/savedSearch.schema.ts";
import {
  ...
  updateAdSchema,
  reseedSchema,
} from "../validation/admin.schema.ts";
import {
  teamInviteSchema,
  ...
  auctionExtendSchema,
  settlementSchema,
} from "../validation/dealer.schema.ts";
import {
  submitApplicationSchema,
  approveApplicationSchema,
  rejectApplicationSchema,
} from "../validation/inspectorApplication.schema.ts";
