...
export default function ProfilePage() {
  ...
  const roleColor = { admin: 'badge-red', dealer: 'badge-gold', buyer: 'badge-blue' };
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 24, marginBottom: 36, flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1, minWidth: 200 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', marginBottom: 4 }}>
              ...
              {user?.role === 'dealer' && user?.approved && <span className="badge badge-green">✓ Verified</span>}
              {user?.role === 'dealer' && !user?.approved && <span className="badge badge-orange">⏳ Pending</span>}
            </div>
