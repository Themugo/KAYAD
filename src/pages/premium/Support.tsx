    ...
    <div className="min-h-screen bg-cream-50 pt-16">
      ...
      <div className="bg-charcoal-900 pt-16 pb-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-serif text-5xl text-white italic mb-4">Support Centre</h1>
            ...
            <div>
              ...
              {sent ? (
                <div className="bg-green-50 border border-green-200 rounded-2xl p-10 text-center">
                  ...
                  <h3 className="font-serif text-2xl text-charcoal-900 italic mb-2">Message Sent!</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center gap-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-serif text-xl text-white italic mb-1">Visit Our Office</h3>
