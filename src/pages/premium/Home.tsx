...
export default function Home({ setPage }: HomeProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* ── HERO ──────────────────────────────────────────────────── */}
      <section className="bg-charcoal-900 pt-28 pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="section-label text-gold-400 mb-5 tracking-widest2">
            EAST AFRICA'S TRUSTED CAR MARKETPLACE
          </p>
          <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl text-white italic font-normal leading-tight mb-6">
            Drive Your Dream Today
          </h1>
          <p className="font-sans text-white/55 text-lg leading-relaxed mb-10 max-w-xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button onClick={() => nav('gallery')} className="btn-outline">
              Sell a Vehicle
            </button>
          </div>
        </div>
      ...
      <section className="bg-charcoal-800 border-t border-white/5">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-gold-700/40">
      ...
      <section className="bg-cream-100 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featured.map(car => (
              <CarCard key={car.id} car={car} onClick={() => nav('gallery')} />
            ))}
          </div>
      ...
      {/* ── CTA ───────────────────────────────────────────────────── */}
      <section className="bg-charcoal-900 py-18">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-16">
          <h2 className="font-serif text-4xl text-white italic mb-4">Ready to Find Your Dream Car?</h2>
