    ...
    <div className="min-h-screen bg-cream-50 pt-16">
      ...
      <div className="bg-charcoal-900 pt-16 pb-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-serif text-5xl text-white italic mb-4">Auction House</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mt-12 bg-charcoal-900 rounded-2xl p-8">
          <h3 className="font-serif text-2xl text-white italic mb-6">Auction Rules &amp; Guidelines</h3>
