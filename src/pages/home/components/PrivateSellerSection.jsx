...
import { Shield, Users, Globe, ArrowRight, Clock } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-white/50 text-sm mb-6 max-w-md leading-relaxed">
              ...
              No dealer license required — pay only when you sell.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                { icon: Clock, text: 'List in 5 Minutes', color: 'var(--orange)' },
