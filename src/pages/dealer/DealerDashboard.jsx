      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px 32px' }}>
        {loading ? (
          ...
          <>
                    ...
                    return (
                      <div key={car._id} style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '14px 24px', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                        ...
                        <div style={{ display: 'flex', gap: 6, marginLeft: 4 }}>
                          <Link to={`/dealer/edit-car/${car._id}`} style={{ width: 30, height: 30, borderRadius: 8, background: 'rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>
                    ...
                    return (
                      <div key={car._id} style={{ background: '#0C0C0C', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 16 }}>
                        ...
                        <div style={{ display: 'flex', gap: 8 }}>
                          ...
                          <Link to={`/dealer/edit-car/${car._id}`} style={{ padding: '7px 14px', borderRadius: 8, background: 'rgba(212,168,67,0.1)', border: '1px solid rgba(212,168,67,0.2)', color: 'var(--gold)', fontSize: 11, fontWeight: 600, textDecoration: 'none' }}>Edit</Link>
            ...
            {/* ── TEAM ── */}
            {tab === 'team' && (
              <div style={{ textAlign: 'center', padding: '48px 20px', background: '#0C0C0C', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 16 }}>
                <div style={{ fontSize: 40, marginBottom: 14 }}>👥</div>
                <h3 style={{ fontFamily: 'var(--font-display)', fontStyle: 'italic', fontSize: '1.3rem', color: '#fff', marginBottom: 8 }}>Team Management</h3>
                <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: 14, maxWidth: 360, margin: '0 auto 24px', lineHeight: 1.7 }}>
                  Manage your sales agents, lot managers, and staff with role-based access control.
                </p>
                <button onClick={() => navigate('/dealer/team')} style={{ padding: '12px 28px', background: 'var(--gold)', border: 'none', borderRadius: 9999, color: '#000', fontSize: 12, fontWeight: 900, cursor: 'pointer', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                  Open Team Manager →
                </button>
              </div>
            )}
