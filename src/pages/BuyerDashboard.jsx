...
import { Heart, Lock, CreditCard, MessageCircle, Star, ChevronRight, TrendingUp, Car, Gavel } from 'lucide-react';
                ...
                {favorites.length === 0 ? (
                  ...
                  return (
                    <Link key={f._id} to={`/cars/${car._id}`} style={{ textDecoration: 'none' }}>
                      ...
                      >
                        {img ? (
                          <img src={img} alt="" style={{ width: 44, height: 36, objectFit: 'cover', borderRadius: 6, flexShrink: 0 }} />
                        ) : (
