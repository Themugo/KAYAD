...
function SectionCard({ title, children, accent = 'var(--gold)' }) {
  return (
    <div style={{ background: '#0C0C0C', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 16, padding: 24, marginBottom: 20 }}>
      <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 700, marginBottom: 16, borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: 12 }}>
...
function StatRow({ label, value, color = '#fff' }) {
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '6px 0', borderBottom: '1px solid rgba(255,255,255,0.03)', fontSize: 13 }}>
            ...
            {SECTIONS.map(s => (
              <Link key={s.key} to={s.path} style={{ textDecoration: 'none' }}>
                <div style={{
                  ...
                  border: `1px solid ${s.danger ? 'rgba(239,68,68,0.2)' : 'rgba(255,255,255,0.06)'}`,
        ...
        {isSuperadmin && (
          <SectionCard title="Demo Data Management" accent="#f59e0b">
            {loading ? (
              ...
              <>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(130px, 1fr))', gap: 10, marginBottom: 20 }}>
                  {[
                    ...
                    <div key={s.label} style={{ padding: '12px 14px', borderRadius: 10, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
              ...
              <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: 13, padding: 12 }}>Unable to load demo status</div>
            )}
          </SectionCard>
        )}
        ...
        <SectionCard title="System Management Staff" accent="#3b82f6">
          <div style={{ fontSize: 13, lineHeight: 1.8, color: 'rgba(255,255,255,0.6)' }}>
            <p style={{ marginBottom: 12 }}>
              The <strong style={{ color: '#fff' }}>Control Room</strong> is the operations hub for <strong style={{ color: 'var(--gold)' }}>Webhost</strong> (superadmin) and <strong style={{ color: '#3b82f6' }}>Admin</strong> roles.
            </p>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              <div style={{ padding: 14, borderRadius: 10, background: 'rgba(251,191,36,0.04)', border: '1px solid rgba(251,191,36,0.1)' }}>
                ...
                <ul style={{ margin: 0, paddingLeft: 16, fontSize: 12, color: 'rgba(255,255,255,0.5)', lineHeight: 2 }}>
