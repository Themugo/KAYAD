...
function GalleryImage({ car, idx, onPrev, onNext, total }) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', aspectRatio: '16/9', background: '#0a0a0a', borderRadius: 16, overflow: 'hidden' }}>
...
export default function CarDetailPage() {
  ...
  return (
    <div style={{ background: '#050505', minHeight: '100vh', paddingBottom: 80 }}>
      ...
      <div style={{ maxWidth: 1320, margin: '0 auto', padding: '20px 28px', display: 'grid', gridTemplateColumns: '1fr 380px', gap: 28, alignItems: 'start' }}>
        ...
        <div>
          ...
          {canManage && (
            <div style={{ display: 'flex', gap: 10, marginTop: 14, padding: '14px 16px', background: '#0C0C0C', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 12 }}>
              ...
              <button onClick={handleTogglePromote} disabled={promoting} style={{
                padding: '9px 18px', borderRadius: 9, border: 'none', cursor: promoting ? 'wait' : 'pointer',
              ...
              <Link to={`/dealer/edit-car/${car._id}`} style={{
          ...
          {car.description && (
            <div style={{ marginBottom: 28, background: '#0C0C0C', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: '22px 24px' }}>
              <div style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.16em', color: 'rgba(212,168,67,0.6)', marginBottom: 12 }}>
                About This Vehicle
              </div>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: 14, lineHeight: 1.85, whiteSpace: 'pre-wrap', margin: 0 }}>
                {car.description}
              </p>
            </div>
          )}
        ...
        <div style={{ position: 'sticky', top: 108 }}>
          ...
          <div style={{ background: '#0C0C0C', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 18, overflow: 'hidden', marginBottom: 12 }}>
            ...
            <div style={{ padding: '22px 24px' }}>
              ...
              {/* CTAs */}
              {isOwner ? (
                <Link to={`/dealer/edit-car/${car._id}`} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '13px', borderRadius: 11, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', color: '#fff', fontSize: 13, fontWeight: 700, textDecoration: 'none' }}>
                  ✏ Edit Your Listing
                </Link>
              ) : (
