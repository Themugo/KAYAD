      ...
      {selected && (
        <div className="modal-overlay" onClick={e => e.target === e.currentTarget && setSelected(null)}>
          <div className="modal-box" style={{ maxWidth: 500 }}>
            ...
            <div style={{ marginTop: 20, padding: '14px 16px', background: 'rgba(200,150,42,0.06)', border: '1px solid rgba(200,150,42,0.15)', borderRadius: 'var(--radius)', fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.6 }}>
