...
const demoDealerCars = (userId) => {
  ...
  // catalogue so it can showcase editing every demo car. The seller demo
...
const demoAdmin = {
  ...
  toggleDemo: async () => {
    await delay();
    return wrapSuccess({ demoMode: true });
  },

  demoReseed: async () => {
    await delay(500, 1100);
    _resetAdminUsers(null);
    return wrapSuccess({ message: 'Demo data reseeded' });
  },
