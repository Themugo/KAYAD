...
export const INITIAL_DEALER_BUSINESSES: Dealer[] = [
  {
    ...
    paymentMethods: ['KAYAD Escrow Vault', 'Bank Wire (RTGS)', 'M-Pesa Business Till #981023', 'NCBA / Co-op Asset Finance'],
  ...
  },
  {
    ...
    languages: ['English', 'Swahili'],
    paymentMethods: ['KAYAD Escrow Vault', 'M-Pesa Business Till #556211', 'Bank Wire Transfer', 'NCBA Asset Finance'],
...
export const INITIAL_DEALER_LEADS: DealerLead[] = [
  ...
  },
  {
    ...
    status: 'In Contact',
    assignedToName: 'Grace Wanjiku',
    notes: 'Inquired about loan pre-approval with Equity Bank option.',
