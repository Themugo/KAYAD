...
export const DEMO_CARS = [
  ...
  { _id:'car-aud1', title:'Audi Q5 2.0 TFSI 2021', brand:'Audi', price:5500000, year:2021, fuel:'Petrol', transmission:'Automatic', mileage:25000, bodyType:'SUV', color:'White', location:{city:'Nairobi'}, description:'Audi Q5 Quattro. Virtual cockpit, Bang & Olufsen sound, S-Line package.', features:['Quattro AWD','Virtual Cockpit','Bang & Olufsen','S-Line','Panoramic Roof','Adaptive Cruise'], images:IMG.audi, views:876, bidsCount:0, currentBid:0, allowBid:false, allowBuy:true, auctionStatus:'draft', auctionEnd:null, isPromoted:false, isVerifiedDealer:true, dealRating:'good', dealer:{_id:'demo-dealer-1',name:'Nairobi Auto Hub Ltd',dealerRating:4.7} },
  { _id:'car-lex1', title:'Lexus RX 350 2022', brand:'Lexus', price:7800000, year:2022, fuel:'Petrol', transmission:'Automatic', mileage:15000, bodyType:'SUV', color:'Silver', location:{city:'Mombasa'}, description:'Lexus RX 350 Luxury Package. Mark Levinson sound, semi-aniline leather.', features:['Mark Levinson','Semi-Aniline Leather','Radar Cruise','Heated/Ventilated Seats','Moonroof','360 Camera'], images:IMG.lex, views:654, bidsCount:2, currentBid:6200000, allowBid:true, allowBuy:true, auctionStatus:'live', auctionEnd:new Date(now+4*DAY).toISOString(), isPromoted:false, isVerifiedDealer:true, dealRating:'fair', dealer:{_id:'dealer-coast1',name:'Coast Auto Traders',dealerRating:4.3} },
  { _id:'car-vw1', title:'Volkswagen Tiguan 2021', brand:'Volkswagen', price:3100000, year:2021, fuel:'Diesel', transmission:'Automatic', mileage:32000, bodyType:'SUV', color:'Blue', location:{city:'Eldoret'}, description:'VW Tiguan 2.0 TDI. Comfortline trim, spacious interior, great fuel economy.', features:['Diesel','Spacious Interior','Bluetooth','Rear Camera','Parking Sensors','Cruise Control'], images:IMG.vw, views:521, bidsCount:0, currentBid:0, allowBid:false, allowBuy:true, auctionStatus:'ended', auctionEnd:null, isPromoted:false, isVerifiedDealer:false, dealRating:'great', dealer:{_id:'dealer-eldoret1',name:'Eldoret Motors',dealerRating:4.0} },
  { _id:'car-hon1', title:'Honda CR-V 2022', brand:'Honda', price:3500000, year:2022, fuel:'Petrol', transmission:'Automatic', mileage:20000, bodyType:'SUV', color:'Grey', location:{city:'Nairobi'}, description:'Honda CR-V 2022, top of the line. Honda Sensing safety suite, leather, moonroof.', features:['Honda Sensing','Leather','Moonroof','Power Tailgate','Apple CarPlay','Lane Keep Assist'], images:IMG.hon, views:445, bidsCount:0, currentBid:0, allowBid:false, allowBuy:true, auctionStatus:'draft', auctionEnd:null, isPromoted:false, isVerifiedDealer:false, dealRating:'good', dealer:{_id:'demo-dealer-1',name:'Nairobi Auto Hub Ltd',dealerRating:4.7} },
