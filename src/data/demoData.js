...
const DEMO_DEALER_REF = { _id: 'demo-dealer-1', name: 'Nairobi Auto Hub Ltd', dealerRating: 4.7, trustScore: 92, verified: true, tier: 'enterprise', verifications: ['email','phone','business','id','ntsa','physical'], escrowMandatory: false, memberSince: '2023', totalTransactions: 342 }; 
...
export const DEMO_ESCROWS = [
  ...
  { _id:'esc-5', buyer:{_id:'other-buyer-3',name:'Kevin Mwangi'}, seller:DEMO_USERS.broker, car:{title:'Mazda Demio 2019'}, amount:890000, status:'funded', createdAt:new Date(now-0.5*DAY).toISOString() },
  { _id:'esc-6', buyer:DEMO_USERS.buyer, seller:DEMO_USERS.broker, car:{title:'Toyota Vitz 2020'}, amount:1250000, status:'released', releasedAt:new Date(now-15*DAY).toISOString(), createdAt:new Date(now-25*DAY).toISOString() },
];
