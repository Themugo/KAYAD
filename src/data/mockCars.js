...
export const MOCK_CARS = [
  ...
  },
  {
    ...
    color: 'White',
    location: { city: 'Nairobi' },
    description: 'Audi Q5 with Quattro all-wheel drive. Virtual cockpit, Bang & Olufsen sound, S-Line package. Immaculate condition.',
    features: ['Quattro AWD', 'Virtual Cockpit', 'Bang & Olufsen', 'S-Line', 'Panoramic Roof', 'Adaptive Cruise'],
    images: IMAGES.audi,
    views: 876,
    bidsCount: 0,
    currentBid: 0,
  ...
  },
  {
    ...
    color: 'Silver',
    location: { city: 'Mombasa' },
    description: 'Lexus RX 350 Luxury Package. Mark Levinson sound, semi-aniline leather, radar cruise control. Premium Japanese reliability.',
  ...
  },
  {
    ...
    description: 'VW Tiguan 2.0 TDI. Comfortline trim, spacious interior, great fuel economy. Perfect family SUV for upcountry use.',
  ...
  },
  {
    ...
    color: 'Grey',
    location: { city: 'Nairobi' },
    description: 'Honda CR-V 2022, top of the line. Honda Sensing safety suite, leather, moonroof, power tailgate. Practical and reliable.',
    features: ['Honda Sensing', 'Leather', 'Moonroof', 'Power Tailgate', 'Apple CarPlay', 'Lane Keep Assist'],
    images: IMAGES.honda,
    views: 445,
    bidsCount: 0,
    currentBid: 0,
