    ...
    <div className="space-y-6 pb-20">
      ...
      <div id="section-tracker" className="space-y-6 pt-4">
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="text-[11px] text-slate-500 font-semibold px-2 py-1.5 rounded-lg bg-slate-50 border border-slate-200">
            Application status is backend/lender authoritative
          </div>
        </div>
