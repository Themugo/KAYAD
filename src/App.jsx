...
// Previously built but never routed anywhere in the app — a full
// route-audit sweep found these 27 admin pages completely
// unreachable (no import in this file, no nested router, no other
// component referencing them at all).
              ...
              <ErrorBoundary>
                <main id="main-content">
                  <Suspense fallback={<LazyFallback />}>
                    ...
                    <Route path="/admin/staff/permissions" element={<RequireAdmin><AdminStaffPermissions /></RequireAdmin>} />
                    ...
                    <Route path="/admin/operations" element={<RequireAdmin><OperationsControlRoom /></RequireAdmin>} />
                    <Route path="/admin/operations-dashboard" element={<RequireAdmin><OperationsDashboard /></RequireAdmin>} />
                    <Route path="/admin/panic-room" element={<RequireAdmin><PanicRoom /></RequireAdmin>} />
                    <Route path="/admin/webhooks" element={<RequireAdmin><WebhoistOverview /></RequireAdmin>} />
