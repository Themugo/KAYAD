...
const DealerOrdersPage     = lazy(() => import('./pages/dealer/pages/DealerOrdersPage'));
const DealerEscrowsPage    = lazy(() => import('./pages/dealer/pages/DealerEscrowsPage'));
const DealerInspectionsPage = lazy(() => import('./pages/dealer/pages/DealerInspectionsPage'));
const DealerCustomersPage  = lazy(() => import('./pages/dealer/pages/DealerCustomersPage'));
const DealerMarketingPage  = lazy(() => import('./pages/dealer/pages/DealerMarketingPage'));
const DealerFinancePage    = lazy(() => import('./pages/dealer/pages/DealerFinancePage'));
const DealerOrganizationPage = lazy(() => import('./pages/dealer/pages/DealerOrganizationPage'));
const DealerSupportPage    = lazy(() => import('./pages/dealer/pages/DealerSupportPage'));
                  ...
                  <CompareProvider>
                    ...
                    <Suspense fallback={<LoadingPage />}>
                      <Routes>
                        ...
                        <Route path="/dealer/inventory"   element={<Dealer><DealerInventoryPage /></Dealer>} />
                        <Route path="/dealer/leads"       element={<Dealer><DealerLeadsPage /></Dealer>} />
                        <Route path="/dealer/orders"      element={<Dealer><DealerOrdersPage /></Dealer>} />
                        <Route path="/dealer/escrows"     element={<Dealer><DealerEscrowsPage /></Dealer>} />
                        <Route path="/dealer/inspections" element={<Dealer><DealerInspectionsPage /></Dealer>} />
                        <Route path="/dealer/customers"   element={<Dealer><DealerCustomersPage /></Dealer>} />
                        <Route path="/dealer/marketing"   element={<Dealer><DealerMarketingPage /></Dealer>} />
                        <Route path="/dealer/finance"     element={<Dealer><DealerFinancePage /></Dealer>} />
                        <Route path="/dealer/organization" element={<Dealer><DealerOrganizationPage /></Dealer>} />
                        <Route path="/dealer/support"     element={<Dealer><DealerSupportPage /></Dealer>} />

                        {/* ── Private Seller ─────────────────────────────────── */}
                        <Route path="/seller"              element={<RequirePrivateSeller><AppLayout><PrivateSellerDashboard /></AppLayout></RequirePrivateSeller>} />
                        <Route path="/seller/onboarding"   element={<RequirePrivateSeller><AppLayout><PrivateSellerOnboarding /></AppLayout></RequirePrivateSeller>} />
                        <Route path="/sell"                element={<RequirePrivateSeller><AppLayout><PrivateSellerAddCar /></AppLayout></RequirePrivateSeller>} />
                        <Route path="/seller/profile"       element={<RequirePrivateSeller><AppLayout><PrivateSellerProfile /></AppLayout></RequirePrivateSeller>} />
                        <Route path="/seller/analytics"     element={<RequirePrivateSeller><AppLayout><SellerAnalytics /></AppLayout></RequirePrivateSeller>} />
                        <Route path="/seller/guide"         element={<RequirePrivateSeller><AppLayout><SellerGuide /></AppLayout></RequirePrivateSeller>} />
                        <Route path="/seller/support"       element={<RequirePrivateSeller><AppLayout><SellerSupport /></AppLayout></RequirePrivateSeller>} />
