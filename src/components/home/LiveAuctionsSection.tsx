...
export const LiveAuctionsSection: React.FC<LiveAuctionsSectionProps> = ({ isLoading: propsIsLoading }) => {
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6 pb-6 border-b border-[#E2D8C7]">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1E3063]/10 border border-[#1E3063]/20 text-[#1E3063] font-mono font-bold text-xs uppercase tracking-wider">
              <Gavel className="w-3.5 h-3.5 text-[#00C9CE]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          {featuredAuction && (
            <div
              ...
              className="lg:col-span-5 bg-white border border-[#E2D8C7] rounded-3xl overflow-hidden hover:border-[#1E3063] hover:shadow-2xl transition-all duration-300 cursor-pointer flex flex-col justify-between group shadow-xs"
            >
              <div className="relative h-64 sm:h-72 overflow-hidden bg-slate-900">
                ...
                <div className="absolute top-3 left-3 z-10 flex flex-col gap-1.5">
                  <span className="px-3 py-1 rounded-xl bg-[#1E3063]/90 backdrop-blur-md text-[#00C9CE] font-mono font-black text-[11px] shadow-md border border-[#00C9CE]/30 flex items-center gap-1">
                    <Flame className="w-3.5 h-3.5 text-[#00C9CE]" />
                    FEATURED AUCTION
                  </span>
                </div>
              ...
              <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between text-xs font-mono font-bold text-[#6B7A99]">
                    ...
                    <span className="flex items-center gap-1 text-[#00C9CE]">
                      <MapPin className="w-3 h-3" />
                      {featuredAuction.location.split(' ')[0]}
                    </span>
                  </div>

                  <h3 className="text-xl font-serif font-black text-[#1E3063] group-hover:text-[#00C9CE] transition-colors line-clamp-1">
                ...
                <div className="p-4 rounded-2xl bg-[#F6F1E8] border border-[#E2D8C7] flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-xl font-mono font-black text-[#1E3063]">
                ...
                <div className="grid grid-cols-2 gap-3 pt-1">
                  <button
                    ...
                    className="py-3 px-4 rounded-2xl bg-[#1E3063] hover:bg-[#121D33] text-white text-xs font-mono font-black uppercase transition-all text-center flex items-center justify-center gap-1.5 shadow-md cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="py-3 px-4 rounded-2xl border-2 border-[#1E3063] text-[#1E3063] hover:bg-[#1E3063] hover:text-white text-xs font-mono font-black uppercase transition-all text-center cursor-pointer"
                  >
                    View Auction
                  </button>
                </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 gap-4">
            {additionalAuctions.map((vehicle) => (
              <div
                ...
                className="group bg-white border border-[#E2D8C7] rounded-3xl p-3.5 sm:p-4 hover:border-[#1E3063] hover:shadow-xl transition-all duration-300 cursor-pointer flex flex-col sm:flex-row items-center gap-4 shadow-xs"
              >
                ...
                <div className="flex-1 min-w-0 space-y-2 w-full">
                  ...
                  <h4 className="text-base font-serif font-black text-[#1E3063] group-hover:text-[#00C9CE] transition-colors truncate">
                    {vehicle.title}
                  </h4>
                  ...
                  <div className="flex items-center justify-between pt-1">
                    <div>
                      ...
                      <span className="text-base font-mono font-black text-[#1E3063]">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-3.5 py-2 rounded-xl bg-[#1E3063] hover:bg-[#121D33] text-white text-xs font-mono font-black uppercase transition-all shadow-sm cursor-pointer"
                      >
                        Place Bid
                      </button>
                      ...
                      <button
                        ...
                        className="px-3 py-2 rounded-xl border border-[#1E3063] text-[#1E3063] text-xs font-mono font-black uppercase transition-all cursor-pointer hover:bg-[#1E3063] hover:text-white"
                      >
                        View
                      </button>
                    </div>
