...
import { MapPin, Gauge, ChevronRight, ShieldCheck, Heart, Eye, Flame, Zap, Settings, BarChart3 } from 'lucide-react';
...
const CartyGrid = memo(function CartyGrid({ car, listView, isMobile }) {
