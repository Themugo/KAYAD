...
export const TrustGateAuctionRules: FC<TrustGateAuctionRulesProps> = ({
    ...
    <div id="trust-gate" className={`p-6 sm:p-8 rounded-3xl bg-white border border-[#E2D8C7] shadow-sm space-y-6 font-sans ${className}`}>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-[#E8E1D5]">
        <div className="space-y-1.5">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#2E4080]/10 text-[#2E4080] text-xs font-mono font-black uppercase tracking-wider border border-[#2E4080]/20">
        ...
        <div className="flex items-center gap-2 self-start md:self-auto">
          {userDepositTier !== 'none' ? (
            <div className="px-4 py-2 rounded-2xl bg-[#3ddb72]/15 border border-[#3ddb72]/40 text-[#2E4080] text-xs font-mono font-black uppercase tracking-wider flex items-center gap-2">
            ...
            <div className="px-4 py-2 rounded-2xl bg-[#23EBFF]/15 border border-[#23EBFF]/40 text-[#2E4080] text-xs font-mono font-black uppercase tracking-wider flex items-center gap-2">
              <AlertCircle className="w-4 h-4 text-[#23EBFF]" />
      ...
      <div className="flex items-center gap-2 bg-[#F6F1E8] p-1.5 rounded-2xl border border-[#E2D8C7] w-fit">
        <button
          ...
          className={`px-4 py-2 text-xs font-mono font-black uppercase tracking-wider rounded-xl transition-all cursor-pointer ${
            activeTab === 'tiers'
              ? 'bg-[#2E4080] text-white shadow-sm'
      ...
      {activeTab === 'tiers' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Standard Tier Card */}
          <div className="p-6 rounded-3xl bg-[#F6F1E8]/60 border-2 border-[#E2D8C7] flex flex-col justify-between space-y-5 hover:border-[#2E4080] transition-all">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="px-3 py-1 rounded-full bg-[#2E4080]/10 text-[#2E4080] text-[11px] font-mono font-black uppercase tracking-wider">
                  Tier 01 · Standard
                </span>
              ...
              <div>
                <span className="text-3xl font-black text-[#2E4080] font-serif">KES 500,000</span>
              ...
              <ul className="space-y-2.5 text-xs text-[#3D4F6F] font-medium pt-2 border-t border-[#E8E1D5]">
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-[#23EBFF] shrink-0" />
            ...
            <Button
              ...
              className="w-full bg-[#2E4080] hover:bg-[#141E3F] text-white font-mono font-black text-xs py-3 uppercase tracking-wider rounded-2xl"
              leftIcon={<Lock className="w-3.5 h-3.5 text-[#23EBFF]" />}
            >
          ...
          {/* Premium Tier Card */}
          <div className="p-6 rounded-3xl bg-[#2E4080] text-white border-2 border-[#2E4080] flex flex-col justify-between space-y-5 shadow-xl relative overflow-hidden">
            <div className="absolute top-0 right-0 px-4 py-1 bg-[#23EBFF] text-[#2E4080] text-[10px] font-mono font-black uppercase tracking-wider rounded-bl-2xl">
              RECOMMENDED VIP
            </div>

            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="px-3 py-1 rounded-full bg-white/10 text-[#23EBFF] text-[11px] font-mono font-black uppercase tracking-wider">
                  Tier 02 · Premium VIP
                </span>
              ...
              <div>
                <span className="text-3xl font-black text-[#23EBFF] font-serif">KES 1,000,000</span>
            ...
            <Button
              ...
              className="w-full bg-[#23EBFF] hover:bg-[#23EBFF] text-[#2E4080] font-mono font-black text-xs py-3 uppercase tracking-wider rounded-2xl shadow-lg"
              leftIcon={<Award className="w-4 h-4 text-[#2E4080]" />}
            >
          ...
          {[
            {
              ...
              icon: <ShieldCheck className="w-5 h-5 text-[#23EBFF]" />
            },
            {
              ...
              icon: <CheckCircle2 className="w-5 h-5 text-[#3ddb72]" />
            },
            {
              ...
              icon: <Scale className="w-5 h-5 text-[#2E4080]" />
            },
            {
              ...
              icon: <FileText className="w-5 h-5 text-[#23EBFF]" />
            }
          ].map((rule, idx) => (
      ...
      <div className="p-4 rounded-2xl bg-[#2E4080] text-slate-200 text-xs flex flex-col sm:flex-row items-center justify-between gap-3 border border-white/10">
        ...
        <a
          href="#trust-gate"
          className="text-[#23EBFF] hover:underline font-mono font-black uppercase text-[11px] tracking-wider flex items-center gap-1"
        >
